...
### Test Sequence
  ...
  Run `roslaunch prbt_moveit_config moveit_planning_execution.launch sim:=False pipeline:=trapezoidal_command_planner sto:=pss4000 has_braketest_support:=true`
